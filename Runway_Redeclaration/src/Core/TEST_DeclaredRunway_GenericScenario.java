...
public class TEST_DeclaredRunway_GenericScenario {
	...
	public static void Setup1() throws VariableDeclarationException{
		//  09L/27R
		make(_09L, _027R,
				90,  12,
	...
	public static void Setup2() throws VariableDeclarationException{
		//  09R/27L
		make(_09R, _027L,
				90, 25,
	...
	public static void Setup3() throws VariableDeclarationException{
		//  09R/27L
		make(_09R, _027L,
				90, 15,
	...
	public static void Setup4() throws VariableDeclarationException{
		//  09L/27R
		make(_09L, _027R,
				90, 20,
	...
	@BeforeClass
	public static void chooseScenario() throws VariableDeclarationException{
	...
	public void test() {
		...
		try {
			...
			if(failed) fail("Exception thrown");
		}
	}
